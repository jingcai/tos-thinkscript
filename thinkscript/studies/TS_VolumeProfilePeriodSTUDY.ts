...
input showLabel = YES;
input barColorRed = 70;
input barColorGreen = 70;
input barColorBlue = 70;
input barWeight = 1;
input startDateYyyyMmDd = 20100101;
input endDateYyyyMmDd = 20100115;
...
def inZone = if today >= startDateYyyyMmDd and today <= endDateYyyyMmDd then 1 else 0;

def top = HighestAll(if inZone then high else 0);
def bottom = LowestAll(if inZone then low else top);
...
rec extBar = compoundValue(1, if today<endDateYyyyMmDd then 0 else if (today == endDateYyyyMmDd) then 1 else extBar[1] + 1,0);

def bin1Total = TotalSum(if inZone and binTop <= 1 and binBottom >= 1 then volume / binParts else 0);
def bin2Total = TotalSum(if inZone and binTop <= 2 and binBottom >= 2 then volume / binParts else 0);
def bin3Total = TotalSum(if inZone and binTop <= 3 and binBottom >= 3 then volume / binParts else 0);
def bin4Total = TotalSum(if inZone and binTop <= 4 and binBottom >= 4 then volume / binParts else 0);
def bin5Total = TotalSum(if inZone and binTop <= 5 and binBottom >= 5 then volume / binParts else 0);
def bin6Total = TotalSum(if inZone and binTop <= 6 and binBottom >= 6 then volume / binParts else 0);
def bin7Total = TotalSum(if inZone and binTop <= 7 and binBottom >= 7 then volume / binParts else 0);
def bin8Total = TotalSum(if inZone and binTop <= 8 and binBottom >= 8 then volume / binParts else 0);
def bin9Total = TotalSum(if inZone and binTop <= 9 and binBottom >= 9 then volume / binParts else 0);
def bin10Total = TotalSum(if inZone and binTop <= 10 and binBottom >= 10 then volume / binParts else 0);
def bin11Total = TotalSum(if inZone and binTop <= 11 and binBottom >= 11 then volume / binParts else 0);
def bin12Total = TotalSum(if inZone and binTop <= 12 and binBottom >= 12 then volume / binParts else 0);
def bin13Total = TotalSum(if inZone and binTop <= 13 and binBottom >= 13 then volume / binParts else 0);
def bin14Total = TotalSum(if inZone and binTop <= 14 and binBottom >= 14 then volume / binParts else 0);
def bin15Total = TotalSum(if inZone and binTop <= 15 and binBottom >= 15 then volume / binParts else 0);
def bin16Total = TotalSum(if inZone and binTop <= 16 and binBottom >= 16 then volume / binParts else 0);
def bin17Total = TotalSum(if inZone and binTop <= 17 and binBottom >= 17 then volume / binParts else 0);
def bin18Total = TotalSum(if inZone and binTop <= 18 and binBottom >= 18 then volume / binParts else 0);
def bin19Total = TotalSum(if inZone and binTop <= 19 and binBottom >= 19 then volume / binParts else 0);
def bin20Total = TotalSum(if inZone and binTop <= 20 and binBottom >= 20 then volume / binParts else 0);
def bin21Total = TotalSum(if inZone and binTop <= 21 and binBottom >= 21 then volume / binParts else 0);
def bin22Total = TotalSum(if inZone and binTop <= 22 and binBottom >= 22 then volume / binParts else 0);
def bin23Total = TotalSum(if inZone and binTop <= 23 and binBottom >= 23 then volume / binParts else 0);
def bin24Total = TotalSum(if inZone and binTop <= 24 and binBottom >= 24 then volume / binParts else 0);
def bin25Total = TotalSum(if inZone and binTop <= 25 and binBottom >= 25 then volume / binParts else 0);
def bin26Total = TotalSum(if inZone and binTop <= 26 and binBottom >= 26 then volume / binParts else 0);
def bin27Total = TotalSum(if inZone and binTop <= 27 and binBottom >= 27 then volume / binParts else 0);
def bin28Total = TotalSum(if inZone and binTop <= 28 and binBottom >= 28 then volume / binParts else 0);
def bin29Total = TotalSum(if inZone and binTop <= 29 and binBottom >= 29 then volume / binParts else 0);
def bin30Total = TotalSum(if inZone and binTop <= 30 and binBottom >= 30 then volume / binParts else 0);
def bin31Total = TotalSum(if inZone and binTop <= 31 and binBottom >= 31 then volume / binParts else 0);
def bin32Total = TotalSum(if inZone and binTop <= 32 and binBottom >= 32 then volume / binParts else 0);
def bin33Total = TotalSum(if inZone and binTop <= 33 and binBottom >= 33 then volume / binParts else 0);
def bin34Total = TotalSum(if inZone and binTop <= 34 and binBottom >= 34 then volume / binParts else 0);
def bin35Total = TotalSum(if inZone and binTop <= 35 and binBottom >= 35 then volume / binParts else 0);
def bin36Total = TotalSum(if inZone and binTop <= 36 and binBottom >= 36 then volume / binParts else 0);
def bin37Total = TotalSum(if inZone and binTop <= 37 and binBottom >= 37 then volume / binParts else 0);
def bin38Total = TotalSum(if inZone and binTop <= 38 and binBottom >= 38 then volume / binParts else 0);
def bin39Total = TotalSum(if inZone and binTop <= 39 and binBottom >= 39 then volume / binParts else 0);
def bin40Total = TotalSum(if inZone and binTop <= 40 and binBottom >= 40 then volume / binParts else 0);
def bin41Total = TotalSum(if inZone and binTop <= 41 and binBottom >= 41 then volume / binParts else 0);
def bin42Total = TotalSum(if inZone and binTop <= 42 and binBottom >= 42 then volume / binParts else 0);
def bin43Total = TotalSum(if inZone and binTop <= 43 and binBottom >= 43 then volume / binParts else 0);
def bin44Total = TotalSum(if inZone and binTop <= 44 and binBottom >= 44 then volume / binParts else 0);
def bin45Total = TotalSum(if inZone and binTop <= 45 and binBottom >= 45 then volume / binParts else 0);
def bin46Total = TotalSum(if inZone and binTop <= 46 and binBottom >= 46 then volume / binParts else 0);
def bin47Total = TotalSum(if inZone and binTop <= 47 and binBottom >= 47 then volume / binParts else 0);
def bin48Total = TotalSum(if inZone and binTop <= 48 and binBottom >= 48 then volume / binParts else 0);
def bin49Total = TotalSum(if inZone and binTop <= 49 and binBottom >= 49 then volume / binParts else 0);
def bin50Total = TotalSum(if inZone and binTop <= 50 and binBottom >= 50 then volume / binParts else 0);

def bin1Totala = TotalSum(if inZone and binTop <= 51 and binBottom >= 51 then volume / binParts else 0);
def bin2Totala = TotalSum(if inZone and binTop <= 52 and binBottom >= 52 then volume / binParts else 0);
def bin3Totala = TotalSum(if inZone and binTop <= 53 and binBottom >= 53 then volume / binParts else 0);
def bin4Totala = TotalSum(if inZone and binTop <= 54 and binBottom >= 54 then volume / binParts else 0);
def bin5Totala = TotalSum(if inZone and binTop <= 55 and binBottom >= 55 then volume / binParts else 0);
def bin6Totala = TotalSum(if inZone and binTop <= 56 and binBottom >= 56 then volume / binParts else 0);
def bin7Totala = TotalSum(if inZone and binTop <= 57 and binBottom >= 57 then volume / binParts else 0);
def bin8Totala = TotalSum(if inZone and binTop <= 58 and binBottom >= 58 then volume / binParts else 0);
def bin9Totala = TotalSum(if inZone and binTop <= 59 and binBottom >= 59 then volume / binParts else 0);
def bin10Totala = TotalSum(if inZone and binTop <= 60 and binBottom >= 60 then volume / binParts else 0);
def bin11Totala = TotalSum(if inZone and binTop <= 61 and binBottom >= 61 then volume / binParts else 0);
def bin12Totala = TotalSum(if inZone and binTop <= 62 and binBottom >= 62 then volume / binParts else 0);
def bin13Totala = TotalSum(if inZone and binTop <= 63 and binBottom >= 63 then volume / binParts else 0);
def bin14Totala = TotalSum(if inZone and binTop <= 64 and binBottom >= 64 then volume / binParts else 0);
def bin15Totala = TotalSum(if inZone and binTop <= 65 and binBottom >= 65 then volume / binParts else 0);
def bin16Totala = TotalSum(if inZone and binTop <= 66 and binBottom >= 66 then volume / binParts else 0);
def bin17Totala = TotalSum(if inZone and binTop <= 67 and binBottom >= 67 then volume / binParts else 0);
def bin18Totala = TotalSum(if inZone and binTop <= 68 and binBottom >= 68 then volume / binParts else 0);
def bin19Totala = TotalSum(if inZone and binTop <= 69 and binBottom >= 69 then volume / binParts else 0);
def bin20Totala = TotalSum(if inZone and binTop <= 70 and binBottom >= 70 then volume / binParts else 0);
def bin21Totala = TotalSum(if inZone and binTop <= 71 and binBottom >= 71 then volume / binParts else 0);
def bin22Totala = TotalSum(if inZone and binTop <= 72 and binBottom >= 72 then volume / binParts else 0);
def bin23Totala = TotalSum(if inZone and binTop <= 73 and binBottom >= 73 then volume / binParts else 0);
def bin24Totala = TotalSum(if inZone and binTop <= 74 and binBottom >= 74 then volume / binParts else 0);
def bin25Totala = TotalSum(if inZone and binTop <= 75 and binBottom >= 75 then volume / binParts else 0);
def bin26Totala = TotalSum(if inZone and binTop <= 76 and binBottom >= 76 then volume / binParts else 0);
def bin27Totala = TotalSum(if inZone and binTop <= 77 and binBottom >= 77 then volume / binParts else 0);
def bin28Totala = TotalSum(if inZone and binTop <= 78 and binBottom >= 78 then volume / binParts else 0);
def bin29Totala = TotalSum(if inZone and binTop <= 79 and binBottom >= 79 then volume / binParts else 0);
def bin30Totala = TotalSum(if inZone and binTop <= 80 and binBottom >= 80 then volume / binParts else 0);
def bin31Totala = TotalSum(if inZone and binTop <= 81 and binBottom >= 81 then volume / binParts else 0);
def bin32Totala = TotalSum(if inZone and binTop <= 82 and binBottom >= 82 then volume / binParts else 0);
def bin33Totala = TotalSum(if inZone and binTop <= 83 and binBottom >= 83 then volume / binParts else 0);
def bin34Totala = TotalSum(if inZone and binTop <= 84 and binBottom >= 84 then volume / binParts else 0);
def bin35Totala = TotalSum(if inZone and binTop <= 85 and binBottom >= 85 then volume / binParts else 0);
...
B1a.AssignValueColor(if bindepth1a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B2a.AssignValueColor(if bindepth2a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B3a.AssignValueColor(if bindepth3a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B4a.AssignValueColor(if bindepth4a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B5a.AssignValueColor(if bindepth5a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B6a.AssignValueColor(if bindepth6a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B7a.AssignValueColor(if bindepth7a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B8a.AssignValueColor(if bindepth8a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B9a.AssignValueColor(if bindepth9a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B10a.AssignValueColor(if bindepth10a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B11a.AssignValueColor(if bindepth11a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B12a.AssignValueColor(if bindepth12a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B13a.AssignValueColor(if bindepth13a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B14a.AssignValueColor(if bindepth14a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B15a.AssignValueColor(if bindepth15a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B16a.AssignValueColor(if bindepth16a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B17a.AssignValueColor(if bindepth17a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B18a.AssignValueColor(if bindepth18a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B19a.AssignValueColor(if bindepth19a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B20a.AssignValueColor(if bindepth20a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B21a.AssignValueColor(if bindepth21a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B22a.AssignValueColor(if bindepth22a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B23a.AssignValueColor(if bindepth23a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B24a.AssignValueColor(if bindepth24a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B25a.AssignValueColor(if bindepth25a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B26a.AssignValueColor(if bindepth26a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B27a.AssignValueColor(if bindepth27a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B28a.AssignValueColor(if bindepth28a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B29a.AssignValueColor(if bindepth29a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B30a.AssignValueColor(if bindepth30a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B31a.AssignValueColor(if bindepth31a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B32a.AssignValueColor(if bindepth32a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B33a.AssignValueColor(if bindepth33a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B34a.AssignValueColor(if bindepth34a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
...
B35a.AssignValueColor(if bindepth35a == barLength then color.yellow else createColor(barColorRed,barColorGreen,barColorBlue));
B35a.setLineWeight(barWeight);

addVerticalLine(today==endDateYyyyMmDd and showLabel, concat(concat("Volume Profile ",daysFromDate(startDateYyyyMmDd))," days "), color.white);
