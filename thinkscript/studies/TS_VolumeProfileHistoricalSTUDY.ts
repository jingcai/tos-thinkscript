# TS_VolumeProfileHistorical
# (c) 2009 http://www.thinkscripter.com 
# All rights reserved
# thinkscripter@gmail.com
# Last Update 04 JAN 2010

# Set CalendarDayOffset to the number of calendar days back you want
# the Volume Profile to display. Any number 1 and up is acceptable
input calendarDayOffset = 1;
input barColorRed = 100;
input barColorGreen = 100;
input barColorBlue = 100;
input barWeight = 1;
input barLength = 50;
def yearMultiplier = if getYear()!=getLastYear() then 1 else 0;

def offsetDay = if getDay() == getLastDay() - calendarDayOffset  + 365*yearMultiplier then 1 else 0;
rec extbar = if getDay() != getDay()[1] then 1 else extBar[1] + 1;

def lastbar = if offsetDay and !offsetDay[-1] then 1 else 0;
...
def bin1Total = TotalSum(if offSetDay and binTop <= 1 and binBottom >= 1 then volume / binParts else 0);
def bin2Total = TotalSum(if offSetDay and binTop <= 2 and binBottom >= 2 then volume / binParts else 0);
def bin3Total = TotalSum(if offSetDay and binTop <= 3 and binBottom >= 3 then volume / binParts else 0);
def bin4Total = TotalSum(if offSetDay and binTop <= 4 and binBottom >= 4 then volume / binParts else 0);
def bin5Total = TotalSum(if offSetDay and binTop <= 5 and binBottom >= 5 then volume / binParts else 0);
def bin6Total = TotalSum(if offSetDay and binTop <= 6 and binBottom >= 6 then volume / binParts else 0);
def bin7Total = TotalSum(if offSetDay and binTop <= 7 and binBottom >= 7 then volume / binParts else 0);
def bin8Total = TotalSum(if offSetDay and binTop <= 8 and binBottom >= 8 then volume / binParts else 0);
def bin9Total = TotalSum(if offSetDay and binTop <= 9 and binBottom >= 9 then volume / binParts else 0);
def bin10Total = TotalSum(if offSetDay and binTop <= 10 and binBottom >= 10 then volume / binParts else 0);
def bin11Total = TotalSum(if offSetDay and binTop <= 11 and binBottom >= 11 then volume / binParts else 0);
def bin12Total = TotalSum(if offSetDay and binTop <= 12 and binBottom >= 12 then volume / binParts else 0);
def bin13Total = TotalSum(if offSetDay and binTop <= 13 and binBottom >= 13 then volume / binParts else 0);
def bin14Total = TotalSum(if offSetDay and binTop <= 14 and binBottom >= 14 then volume / binParts else 0);
def bin15Total = TotalSum(if offSetDay and binTop <= 15 and binBottom >= 15 then volume / binParts else 0);
def bin16Total = TotalSum(if offSetDay and binTop <= 16 and binBottom >= 16 then volume / binParts else 0);
def bin17Total = TotalSum(if offSetDay and binTop <= 17 and binBottom >= 17 then volume / binParts else 0);
def bin18Total = TotalSum(if offSetDay and binTop <= 18 and binBottom >= 18 then volume / binParts else 0);
def bin19Total = TotalSum(if offSetDay and binTop <= 19 and binBottom >= 19 then volume / binParts else 0);
def bin20Total = TotalSum(if offSetDay and binTop <= 20 and binBottom >= 20 then volume / binParts else 0);
def bin21Total = TotalSum(if offSetDay and binTop <= 21 and binBottom >= 21 then volume / binParts else 0);
def bin22Total = TotalSum(if offSetDay and binTop <= 22 and binBottom >= 22 then volume / binParts else 0);
def bin23Total = TotalSum(if offSetDay and binTop <= 23 and binBottom >= 23 then volume / binParts else 0);
def bin24Total = TotalSum(if offSetDay and binTop <= 24 and binBottom >= 24 then volume / binParts else 0);
def bin25Total = TotalSum(if offSetDay and binTop <= 25 and binBottom >= 25 then volume / binParts else 0);
def bin26Total = TotalSum(if offSetDay and binTop <= 26 and binBottom >= 26 then volume / binParts else 0);
def bin27Total = TotalSum(if offSetDay and binTop <= 27 and binBottom >= 27 then volume / binParts else 0);
def bin28Total = TotalSum(if offSetDay and binTop <= 28 and binBottom >= 28 then volume / binParts else 0);
def bin29Total = TotalSum(if offSetDay and binTop <= 29 and binBottom >= 29 then volume / binParts else 0);
def bin30Total = TotalSum(if offSetDay and binTop <= 30 and binBottom >= 30 then volume / binParts else 0);
def bin31Total = TotalSum(if offSetDay and binTop <= 31 and binBottom >= 31 then volume / binParts else 0);
def bin32Total = TotalSum(if offSetDay and binTop <= 32 and binBottom >= 32 then volume / binParts else 0);
def bin33Total = TotalSum(if offSetDay and binTop <= 33 and binBottom >= 33 then volume / binParts else 0);
def bin34Total = TotalSum(if offSetDay and binTop <= 34 and binBottom >= 34 then volume / binParts else 0);
def bin35Total = TotalSum(if offSetDay and binTop <= 35 and binBottom >= 35 then volume / binParts else 0);
def bin36Total = TotalSum(if offSetDay and binTop <= 36 and binBottom >= 36 then volume / binParts else 0);
def bin37Total = TotalSum(if offSetDay and binTop <= 37 and binBottom >= 37 then volume / binParts else 0);
def bin38Total = TotalSum(if offSetDay and binTop <= 38 and binBottom >= 38 then volume / binParts else 0);
def bin39Total = TotalSum(if offSetDay and binTop <= 39 and binBottom >= 39 then volume / binParts else 0);
def bin40Total = TotalSum(if offSetDay and binTop <= 40 and binBottom >= 40 then volume / binParts else 0);
def bin41Total = TotalSum(if offSetDay and binTop <= 41 and binBottom >= 41 then volume / binParts else 0);
def bin42Total = TotalSum(if offSetDay and binTop <= 42 and binBottom >= 42 then volume / binParts else 0);
def bin43Total = TotalSum(if offSetDay and binTop <= 43 and binBottom >= 43 then volume / binParts else 0);
def bin44Total = TotalSum(if offSetDay and binTop <= 44 and binBottom >= 44 then volume / binParts else 0);
def bin45Total = TotalSum(if offSetDay and binTop <= 45 and binBottom >= 45 then volume / binParts else 0);
def bin46Total = TotalSum(if offSetDay and binTop <= 46 and binBottom >= 46 then volume / binParts else 0);
def bin47Total = TotalSum(if offSetDay and binTop <= 47 and binBottom >= 47 then volume / binParts else 0);
def bin48Total = TotalSum(if offSetDay and binTop <= 48 and binBottom >= 48 then volume / binParts else 0);
def bin49Total = TotalSum(if offSetDay and binTop <= 49 and binBottom >= 49 then volume / binParts else 0);
def bin50Total = TotalSum(if offSetDay and binTop <= 50 and binBottom >= 50 then volume / binParts else 0);
